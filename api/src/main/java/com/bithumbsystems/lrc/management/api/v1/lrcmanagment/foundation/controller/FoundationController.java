...
public class FoundationController {
    ...
    @Operation(summary = "재단 계약 상태 가져오기", description = "재단 계약 상태 목록 정보를 조회합니다.", tags = "사이트 운영  > 거래지원 관리 > 재단 계약상태 검색")
    ...
    @Operation(summary = "재단 검색 하기", description = "재단 정보를 저장합니다.", tags = "사이트 운영 > 거래지원 관리 > 재단 검색")
