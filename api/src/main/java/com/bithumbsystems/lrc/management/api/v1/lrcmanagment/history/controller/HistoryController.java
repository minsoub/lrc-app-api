...
public class HistoryController {
     ...
     */
    @GetMapping("/history")
    @Operation(summary = "히스토리 모두 가져오기", description = "히스토리 로그 목록 정보를 조회합니다.", tags = "사이트 운영 > 거래지원 관리 > 변경히스토리 > 검색")
     ...
     */
    @PostMapping("/history")
    @Operation(summary = "히스토리 1개 저장하기", description = "히스토리 로그 정보 저장합니다.", tags = "사이트 운영 > 거래지원 관리 > 변경히스토리 > 저장")
